 ...
 * @author Engkoi Zidac
 */
public class ActedBySearch extends javax.swing.JDialog {

    public static TagRequest frmParent;
    static Statement stmt;
    static DefaultTableCellRenderer cellAlignCenterRenderer = new DefaultTableCellRenderer();
    static DefaultTableCellRenderer renderer = new DefaultTableCellRenderer();
    static DefaultTableModel model;

    public ActedBySearch(TagRequest parent, boolean modal) {
    ...
    void SelectNow() {
        ...
        if (tbl.isRowSelected(row) != true) {
            ...
            frmParent.SetActedBy(Integer.parseInt(CrewID), CrewName);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActedBySearch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ActedBySearch dialog = new ActedBySearch(frmParent, true);
