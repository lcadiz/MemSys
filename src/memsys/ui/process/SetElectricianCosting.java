 ...
 * @author EngkoiCadiz
 */
public class SetElectricianCosting extends javax.swing.JDialog {
    ...
    public SetElectricianCosting(CostingOp parent, boolean modal) {
    ...
    void SelectNow() {
        ...
        if (tbl.isRowSelected(row) != true) {
            ...
            frmParent.SetElectrician(Integer.parseInt(CrewID), CrewName);
            this.dispose();
            JOptionPane.showMessageDialog(this, "Electrician Updated Successfully!");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("List of Authorized NORECO I Electrician");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SetElectricianCosting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SetElectricianCosting dialog = new SetElectricianCosting(frmParent, true);
