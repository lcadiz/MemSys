...
public class EditElectrician extends javax.swing.JDialog {
    ...
    public EditElectrician(TransactionInquiry parent, boolean modal) {
    ...
    void SelectNow() {
        ...
        if (tbl.isRowSelected(row) != true) {
            ...
            UpdateElectricianID(Integer.parseInt(CrewID));
            frmParent.populateTBLAI();
            this.dispose();
