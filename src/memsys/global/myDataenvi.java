...
public class myDataenvi {
    ...
    public static boolean checkCosting(int acctno) {
        ...
        String createString;
        createString = "SELECT AcctNo FROM costingTBL WHERE AcctNo=" + acctno;
        //stmtIncomingShed
    ...
    public static boolean checkCosting2(int acctno) {
        boolean fexist = false;
    ...
    public static void rsAddParticipants(int bID, String lname, String fname, String mname, String ext, String address, String date_encoded, int bid) {
        Connection conn = MainDBConn.getConnection();
        String createString;
        createString = "INSERT INTO dbo.participantsTBL(batchID,part_lname,part_fname,part_mname,part_ext,address,date_encoded, brgyID) "
                + "VALUES ('" + bID + "','" + lname + "','" + fname + "','" + mname + "','" + ext + "','" + address + "','" + date_encoded + "'," + bid + " )";
    ...
    public static void rsUpdateParticipant(String lname, String fname, String mname, String ext, String address, String pID, int bid) {
        Connection conn = MainDBConn.getConnection();
        String createString;
    ...
    public static void rsAddProfile(String acctname, String bdate, String bplace, int sex, int civil_status, String address, String highest_edu, String occupation, String employer, String position, String monthly_income, String spouse_name, String spouse_age, String spouse_occupation, String father, String mother, String ref1_name, String ref1_position, String ref1_address, String ref2_name, String ref2_position, String ref2_address, String status, String date_encoded, int juri, String pid, int type, String contactno, String emailadd, String mcn, int sanitizeID, String acode) {
        ...
        createString = "INSERT INTO dbo.membersTBL"
                ...
                + "type, "
                + "contactNo, "
                + "emailAdd, mcn, sanitizeID, areacode "
                + ") "
                + "VALUES "
                + "('" + acctname + "','" + bdate + "','" + bplace + "','" + sex + "','" + civil_status + "','" + address + "','" + highest_edu + "','" + occupation + "','" + employer + "','" + position + "','" + monthly_income + "','" + spouse_name + "','" + spouse_age + "','" + spouse_occupation + "','" + father + "','" + mother + "','" + ref1_name + "','" + ref1_position + "','" + ref1_address + "','" + ref2_name + "','" + ref2_position + "','" + ref2_address + "','" + status + "','" + date_encoded + "','" + juri + "','" + pid + "','" + type + "','" + contactno + "','" + emailadd + "','" + mcn + "'," + sanitizeID + ",'" + acode + "')";
    ...
    public static void AddConsumer(String acctno) {
        ...
        createString = "INSERT INTO Consumer(AcctNo, "
                ...
                + "UserID, "
                + "TransDate, BrgyCode) "
                + "SELECT AcctNo, TownCode, RouteCode, AcctCode, RouteSeqNo, ClassCode, AcctName, AcctAddress, MembershipID, " + ParentWindow.getUserID() + ",'" + nowDate2 + "', BrgyCode "
    ...
    public static void rsAddConn(String tcode, String rcode, String rseq, String accountname, String address, String classCode, String memid, String acctcode, String add, int ctype, String transdate, String edate, int AcctNO, String bid) {
        Connection conn = MainDBConn.getConnection();
        String createString;
        createString = "INSERT INTO dbo.connTBL "
                + "("
                + "TownCode, RouteCode, RouteSeqNo, AcctName, ClassCode,MembershipID, AcctCode, AcctAddress, connType, TransDate, expiryDate, AcctNo, Status, BrgyCode"
                + ")"
                + "VALUES"
                + "("
                + "'" + tcode + "',"
